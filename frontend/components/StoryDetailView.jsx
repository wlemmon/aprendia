      ...
      <div className="mb-8">
        ...
        <div className="flex gap-4 overflow-x-auto pb-4">
          {chapters.map((chapter) => (
            <div
              key={chapter.id}
              className="flex-shrink-0 w-64 glass-card rounded-xl overflow-hidden"
            >
              <div className="p-4">
                ...
                {chapter.sentences && chapter.sentences.length > 0 ? (
                  <>
                    ...
                    <button
                      ...
                      className="w-full glass-button-primary text-white py-2 px-4 rounded-lg mb-2"
                    >
                      Study Chapter
                    </button>
                    <button
                      onClick={() => handleCreateQuiz(chapter.id)}
                      className="w-full glass-button text-white py-2 px-4 rounded-lg text-sm"
                    >
                      Create Quiz
                    </button>
                  </>
          ...
          <button
            ...
            className="flex-shrink-0 w-64 h-48 glass rounded-xl border-2 border-dashed border-white/30 hover:border-white/50 hover:bg-white/20 transition flex items-center justify-center"
          >
            <div className="text-center">
              <div className="text-4xl text-white/60 mb-2">+</div>
              <div className="text-white/80 font-medium">Create Chapter</div>
            </div>
          </button>
        </div>
      </div>
                  ...
                  {quiz.sentences && quiz.sentences.length > 0 ? (
                    <>
                      ...
                      <button
                        ...
                        className="w-full glass-button-primary text-white py-2 px-4 rounded-lg"
                      >
                        Start Quiz
                      </button>
                    </>
